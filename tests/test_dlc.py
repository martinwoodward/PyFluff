...
class TestDLCManager:
    ...
    def mock_furby(self) -> FurbyConnect:
        ...
        furby.remove_gp_callback = MagicMock(
            side_effect=lambda cb: (
                furby._gp_callbacks.remove(cb) if cb in furby._gp_callbacks else None
            )
        )
        return furby
    ...
    def test_file_transfer_callback_ready_to_receive(self, dlc_manager: DLCManager) -> None:
    ...
    def test_file_transfer_callback_received_ok(self, dlc_manager: DLCManager) -> None:
    ...
    def test_file_transfer_callback_received_error(self, dlc_manager: DLCManager) -> None:
    ...
    def test_file_transfer_callback_timeout(self, dlc_manager: DLCManager) -> None:
    ...
    def test_file_transfer_callback_invalid_packet(self, dlc_manager: DLCManager) -> None:
    ...
    def test_file_transfer_callback_unknown_mode(self, dlc_manager: DLCManager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_dlc_file_not_found(self, dlc_manager: DLCManager, tmp_path: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_activate_dlc(self, dlc_manager: DLCManager, mock_furby: FurbyConnect) -> None:
    ...
    @pytest.mark.asyncio
    async def test_deactivate_dlc(self, dlc_manager: DLCManager, mock_furby: FurbyConnect) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_dlc(self, dlc_manager: DLCManager, mock_furby: FurbyConnect) -> None:
